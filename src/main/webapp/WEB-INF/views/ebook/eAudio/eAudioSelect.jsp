...
<title>Insert title here</title>
	...
	body{
		...
		@media (min-width:760px){ /* 데스크탑 환경일때 패널(collapse) 숨기기 */
			.panelHide{
				display:none;
			}
		}
	...
	function aPlayer(){//오디오플레이어 팝업
		var popURL = "aPlayer.ju";
			  ...
			  <div class="col-md-12">
				<div class="media">
				  <div class="media-left media">
				    <a href="#">
				      <img class="media-object" src="/lee/resources/ebookSelect/img/1.jpg" style="width: 100px; height: 150px;"  alt="..." >
				    </a>
				  </div>
				  ...
				  <br>
				    <h4 class="media-heading">서울역</h4>
				    	<div class="row">
					    	<div class="col-md-1">저자</div><div class="col-md-11">박영란</div>
					    	<div class="col-md-1">출판사</div><div class="col-md-11">자음과 모음</div>
					    	<div class="col-md-1">제작일</div><div class="col-md-11">2015.08.19</div>
							<div class="col-md-1">추천수</div><div class="col-md-11">0</div>
							<div class="col-md-1">대출</div><div class="col-md-11">0/5</div>
							<div class="col-md-1">예약</div><div class="col-md-11">0</div>
							<div class="col-md-3 col-md-offset-9">
								<input class="btn btn-default" type="button" value="대출하기" onclick="aPlayer()">
			...
			<div class="panelHide">
				<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				  <div class="panel panel-default">
				    <div class="panel-heading" role="tab" id="workIntro" style="text-align: center;">
				    ...
				    <div id="openFind" class="panel-collapse collapse" role="tabpanel" aria-labelledby="workIntro">
