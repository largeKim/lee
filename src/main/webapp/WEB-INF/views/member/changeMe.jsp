...
<script type="text/javascript">
	...
	var mem_pwd = ${dto.mem_pwd}
	var input_pwd = $("#input_pwd").val();
	
		if(mem_pwd == input_pwd){
...
<div class="panel panel-default row">
    <div class="panel-heading" role="tab" id="headingTwo">
      <h4 class="panel-title">
        <a class="collapsed" id="headingTwoA" >
          개인정보
        </a>
      </h4>
    </div>
      ...
      <div class="panel-body ">
      	...
      	<!-- 아이디 -->
	      	...
	      	<label class="col-md-12" for="sel1">아이디</label>
				 	...
				 	<div class="col-md-4" >
				 		<input type="text" id="idid"class="form-control" value="${dto.mem_id }" aria-describedby="basic-addon2" readonly required>
				 	</div>	
...
<div class="row">
        ...
        <div class="col-md-4">
													<!-- 이름 -->
		  <input type="text" id="memname" class="form-control" value="${dto.mem_name}" aria-describedby="basic-addon2" maxlength="4"  readonly required>	
		</div>
		<script>
...
<div class="row">
        ...
        <br>
        <br>
         <button id="memberInput" class="collapsed btn btn-primary"  >
	      작성완료</button>
